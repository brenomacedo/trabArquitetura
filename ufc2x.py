...
# X <- 0
## X <- 0; GOTO 0
firmware[70] = 0b00000000000000010000000100000000

# X <- X ** X
## H, Y <- X; GOTO 72
firmware[71] = 0b00100100000000010100000011000011
## X <- 0; GOTO 73
firmware[72] = 0b00100100100000010000000100000000
## if Y == 0; GOTO 256 + 74; else GOTO 74
firmware[73] = 0b00100101000100010100000000000100
### [329] Y é zero, GOTO next
firmware[330] = 0b00000000010000110101001000001001
### [73] Y não é zero
## Y <- Y - 1; GOTO 75
firmware[74] = 0b00100101100000110110000010000100
## X <- X + H; GOTO 73
firmware[75] = 0b00100100100000111100000100000011
